 ...
 */
@PrepareForTest({ GridStatistics.class, BrowserInformationCache.class, RegistryBasedServlet.class, Registry.class })
public class GridStatisticsTest extends PowerMockTestCase {
    ...
    public void testValidResponse() throws Exception {
        ...
        List<BrowserStatistics> browserStatisticsList = new ArrayList<BrowserStatistics>();
