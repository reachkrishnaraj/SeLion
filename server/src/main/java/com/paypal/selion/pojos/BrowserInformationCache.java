...
public class BrowserInformationCache {
    ...
    private BrowserInformationCache() {
        nodeMap = new ConcurrentHashMap<URL, TestSlotInformation>(INITIAL_CAPACITY);
    }
     ...
     */
    public synchronized void updateBrowerInfo(URL url, String browserName, int maxInstances) {
    ...
    private static class TestSlotInformation {
        ...
        private TestSlotInformation() {
            browserInformationSet = new HashSet<BrowserInformation>();
        }
         ...
         * @return True if addition is successful, false othewise.
         */
